...
public:
	...
	virtual ~Rpd() = default;
	virtual void draw(Mat const& designImage, vector<Tooth> const teeth[nZones]) const = 0;
protected:
...
protected:
	RpdAsMajorConnector(vector<Position> const& positions, bool const hasLingualConfrontations[nZones][nTeethPerZone]);
	void draw(Mat const& designImage, vector<Tooth> const teeth[nZones]) const override;
...
private:
	CombinationAnteriorPosteriorPalatalStrap(vector<Position> const& positions, bool const hasLingualConfrontations[nZones][nTeethPerZone]);
	void draw(Mat const& designImage, vector<Tooth> const teeth[nZones]) const override;
};
...
public:
	...
	void setSide(vector<Tooth> const teeth[nZones]);
...
private:
	FullPalatalPlate(vector<Position> const& positions, bool const hasLingualConfrontations[nZones][nTeethPerZone]);
	void draw(Mat const& designImage, vector<Tooth> const teeth[nZones]) const override;
};
...
private:
	LingualBar(vector<Position> const& positions, bool const hasLingualConfrontations[nZones][nTeethPerZone]);
	void draw(Mat const& designImage, vector<Tooth> const teeth[nZones]) const override;
};
...
private:
	LingualPlate(vector<Position> const& positions, bool const hasLingualConfrontations[nZones][nTeethPerZone]);
	void draw(Mat const& designImage, vector<Tooth> const teeth[nZones]) const override;
};
...
private:
	PalatalPlate(vector<Position> const& positions, bool const hasLingualConfrontations[nZones][nTeethPerZone]);
	void draw(Mat const& designImage, vector<Tooth> const teeth[nZones]) const override;
};
